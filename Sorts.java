...
public class Sorts {
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<Integer>> casesForMergeSort = new ArrayList<ArrayList<Integer>>();
        for (int b = 0; b < 12; b++) {
        ...
        for (int a = 0; a < 12; a++) {
            ...
            mergeSorts[a] = new MergeSort(casesForMergeSort.get(a));
